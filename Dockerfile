...
#
############################################################
# Dockerfile to wrap up r and libraries that I commonly use
# Based on r-base 
############################################################
...
# create an R user
#ENV HOME /home/jespinosa
#RUN useradd --create-home --home-dir $HOME jespinosa \
#    && chown -R jespinosa:jespinosa $HOME
